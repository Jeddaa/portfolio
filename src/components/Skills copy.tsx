  ...
  return (
    <div className="mt-5">
      ...
      <div className="grid grid-cols-4 gap-4 p-3">
        <div>
          <div className="border rounded-md flex flex-col justify-center items-center gap-2 bg-gray-900 h-20">
            <BsGit className="text-red-700" />
            Python
          </div>
      ...
      <div>
        ...
        <div className="border rounded-md flex flex-col justify-center items-center gap-2 bg-gray-900 h-20">
          <SiPython className="text-amber-200" />
          Python
        </div>
      </div>
    </div>
