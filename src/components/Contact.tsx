...
const Contact = () => {
  return (
    <fieldset
      className="border-t-2 border-b-2 border-amber-300 flex flex-col items-center gap-3 my-5 py-8 w-full font-roboto"
      id="contact">
      <legend className="text-center text-3xl text-amber-300 bg-slate-800 px-2">
        Contact
      </legend>
      <div className="flex gap-5 fx:gap-3 fx:flex-col">
